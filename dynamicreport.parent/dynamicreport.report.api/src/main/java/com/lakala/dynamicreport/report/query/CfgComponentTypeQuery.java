 ...
 * @since 2019-09-16
 */
@ApiModel(value = "报表组件类型查询对象",description = "报表组件类型查询对象(CfgComponentTypeQuery)",
        parent = BaseQuery.class)
public class CfgComponentTypeQuery extends BaseQuery {
    ...
    @ApiModelProperty(value = "组件类型key",name="key")
    private String key;
    ...
    @ApiModelProperty(value = "父类key",name="parentKey")
