 ...
 * @since 2019-09-16
 */
public interface ICfgParamService extends IBaseService<CfgParam, String>{
    /**
     * 带条件分页查询
     *
     * @param cfgParamQuery
     * @return
     */
    Page<CfgParam> findCfgParamCriteria(CfgParamQuery cfgParamQuery);
     ...
     * @return
     */
    List<CfgParam> findCfgParam(CfgParamQuery cfgParamQuery);
