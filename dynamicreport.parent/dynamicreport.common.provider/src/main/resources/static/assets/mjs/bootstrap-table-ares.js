...
(function ($) {
    ...
    BootstrapTable.prototype.initServer = function (silent, query, url) {
        ...
        /**BEG 自定义查询  add by daiwk BEG**/
        $.extend(data,this.options.customerQuery);
        /**END 自定义查询  add by daiwk END**/
        ...
        if (this.options.ajax) {
            ...
            /**BEG 将url添加随机数字 add by daiwk BEG**/
            ...
            /**END 将url添加随机数字 add by daiwk END**/
            
            /**BEG 传统的方式来序列化数据 add by daiwk BEG**/
            request.traditional = true;
            /**END 传统的方式来序列化数据 add by daiwk END**/
