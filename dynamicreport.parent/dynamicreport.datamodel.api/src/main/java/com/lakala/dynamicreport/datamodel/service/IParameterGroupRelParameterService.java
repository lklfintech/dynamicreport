 ...
 * @since 2019-09-16
 */
public interface IParameterGroupRelParameterService extends IBaseService<ParameterGroupRelParameter, Long>{

 
	/**
	 * 带条件查询
	 * 
	 * @param parameterGroupRelParameterQuery
	 * @return
	 */
	List<ParameterGroupRelParameter> findGroupParametes(ParameterGroupRelParameterQuery parameterGroupRelParameterQuery);
